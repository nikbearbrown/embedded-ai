...
This book teaches AI on constrained hardware. The chapter-level *A note about AI* sections cover the core craft chapters; the appendices are quick references where the AI angle is uniform. The unifying principle: **architecture from the model, deployment specifics from your profiler.** The model can explain quantization, walk through model selection trade-offs, and describe the standard toolchains. It cannot predict how a specific model will perform on your specific chip with your specific workload — those numbers come from your profiler, your benchmark, your power meter. Use the model to understand the architecture. The deployment evidence is in the measurements you run yourself.
